...
$root_path = "//192.168.207.6/jtecdata/JTEC_PD_PROGAM/07. Ban ve/man_hinh_2";
...
function convertPdfToBase64($path){
    return 'data:application/pdf;base64,'.chunk_split(base64_encode(file_get_contents($path)));
}
function str_replace_path($path)
{
    return trim(str_replace('_','',str_replace('/', "_\_", $path)));
}
