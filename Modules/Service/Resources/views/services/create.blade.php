                ...
                <div class="form-body">
                    <div class="card-body">
                        <div class="row ">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="title">Service Title <span
                        ...
                        <div class="row ">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="image">Service Featured Image <span
                                            class="optional">(optional)</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="banner_image">Service Banner Image <span
                                            class="optional">(optional)</span></label>
                                    <input type="file" class="form-control dropify" data-height="70"
                        ...
                        <div class="row ">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label" for="description">Service Description <span
                                            class="optional">(optional)</span></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label" for="meta_description">Service Meta Description <span
                                            class="optional">(optional)</span></label>
                                ...
                                <div class="form-actions">
                                    <div class="card-body">
                                        <button type="submit" class="btn btn-success"> <i class="fa fa-check"></i>
                                            Lưu</button>
                                        <a href="{{ route('admin.services.index') }}" class="btn btn-dark">Hủy</a>
                                    </div>
                                </div>
                            </div>
