...
@section('admin-content')
    ...
    <div class="container-fluid">
        ...
        <div class="table-responsive product-table">
            <table class="table table-striped table-bordered display ajax_view" id="departments_table">
                <thead>
                    <tr>
                        <th>Sl</th>
                        <th>Name</th>
...
@section('scripts')
    <script>
    const ajaxURL = "<?php echo Route::is('admin.departments.trashed' ? 'departments/trashed/view' : 'departments') ?>";
