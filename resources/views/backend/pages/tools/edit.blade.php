...
@section('admin-content')
  ...
  <div class="container-fluid">
        ...
        <div class="create-page">
            <form action="{{ route('admin.assets.update', ['id' => $asset->id]) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="col-6 align-items-center justify-content-center mx-auto">
                            <div class="w-100">
                                <div class="form-group">
                                    <label class="control-label" for="code">Mã công cụ<span
                                            class="required">*</span></label>
                                    <input type="text" class="form-control"
                                        data-parsley-required-message="Mã công cụ là bắt buộc" id="code" name="code"
                                        value="{{ $asset->code }}" placeholder="" required="">
                                </div>
                            </div>
                            <div class="w-100">
                                <div class="form-group">
                                    <label class="control-label" for="name">Tên công cụ<span
                                            class="required">*</span></label>
                                    <input type="text" data-parsley-required-message="Tên công cụ là bắt buộc"
