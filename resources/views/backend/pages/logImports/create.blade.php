...
@section('admin-content')
    ...
    <div class="container-fluid">
        ...
        <div class="create-page">
            <form action="{{ route('admin.logImports.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate data-parsley-focus="first">
                @csrf
                <div class="form-body">
                    <div class="card-body">
                        <div class="row ">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-actions">
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('admin.logImports.index') }}" class="btn btn-dark">Cancel</a>
                                    </div>
                                </div>
                            </div>
