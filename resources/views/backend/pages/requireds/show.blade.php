                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('public/assets/images/requireds/'.$required->image) }}" alt="Image" class="img width-100" />
                                    @else
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-actions">
                                    <div class="card-body">
                                        <a  class="btn btn-success" href="{{ route('admin.requireds.edit', $required->id) }}"> <i class="fa fa-edit"></i> Edit Now</a>
                                        <a href="{{ route('admin.requireds.index') }}" class="btn btn-dark ml-2">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
