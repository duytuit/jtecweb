                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br>
                                    @if ($required->image != null)
                                    <img src="{{ asset('public/assets/images/warehouses/'.$required->image) }}" alt="Image" class="img width-100" />
                                    @else
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-success">
                                    ...
                                    <br>
                                    {{ $required->status === 1 ? 'Active' : 'Inactive' }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-actions">
                                    <div class="card-body">
                                        <a  class="btn btn-success" href="{{ route('admin.warehouses.edit', $required->id) }}"> <i class="fa fa-edit"></i> Edit Now</a>
                                        <a href="{{ route('admin.warehouses.index') }}" class="btn btn-dark ml-2">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
