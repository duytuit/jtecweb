        ...
        <tbody>
          <tr>
            ...
            <td class="bgc-C0FFC0 py-0">
              <input name="inputvalue1" class="input-value" type="number" data-target="9">
            </td>
          ...
          <tr>
            ...
            <td>&gt;=15</td>
            <td class="bgc-C0FFFF">
              <input name="inputvalue2" class="input-value" type="number" data-target="15">
            </td>
            <td class="td-color"></td>
          </tr>
          <tr>
            ...
            <td>&gt;=29</td>
            <td class="bgc-C0C0FF">
              <input name="inputvalue3" class="input-value" type="number" data-target="29">
            </td>
            <td class="td-color"></td>
          </tr>
          <tr>
