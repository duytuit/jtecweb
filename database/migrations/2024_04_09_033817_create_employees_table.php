...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            $table->dateTime('birthday')->comment('năm sinh');
            ...
            $table->integer('worker')->default(1)->comment('tình trạng làm việc:0:nghỉ việc,1 nghỉ chế độ bảo hiểm,2: nghỉ không lương,3: đang làm việc');
            ...
            $table->dateTime('begin_date_company')->comment('ngày bắt đầu làm việc');
            $table->dateTime('end_date_company')->comment('ngày kết thúc làm việc');
