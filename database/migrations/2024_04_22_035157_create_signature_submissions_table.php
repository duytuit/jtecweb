...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('signature_submissions', function (Blueprint $table) {
            ...
            $table->integer('positions')->comment('chức vụ:1:General Director,2:Director,3:Supper Manager,4: Manager, 5:Supper Chief, 6:Chief, 7:Staff, 8:Suppser Leader, 9:Leader, 10:Sub Leader, 11:worker');
            $table->integer('approve_id')->comment('người phê duyệt');
